...
export default function EditMusic({ params }: { params: { id: string } }) {
  ...
  const handleComposerChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setSong((prevSong) => (prevSong ? { ...prevSong, id_composer: selectedComposerId } : null));
  };
  const handleSubmit = async () => {
      ...
      const songData = {
          ...
          composer: song?.id_composer || null,
      ...
      try {
          ...
          console.log("Dữ liệu đang được gửi của nhạc sĩ:", JSON.stringify(songData,null,2));
  ...
  return (
      <div className={styles.container}>
        ...
        <select value={song?.id_composer || ""} onChange={handleComposerChange}>
