    ...
    <div className={styles.sidebar}>
      <div className={styles.user}>
        <img
          ...
          src={
            profileData?.url_avatar ? profileData.url_avatar : "/Group 66.svg"
          }
          alt="User Avatar"
        />
        ...
        <div className={styles.userInfo}>
          <p className={styles.userName}>
            <b>{profileData?.fullname ? profileData.fullname : ""}</b>
          </p>
      ...
      <ul className={styles.menu}>
        ...
        <li>
          <Link
            ...
            className={clsx(styles.menuItem, {
              [styles.active]: pathname === "/admin/adminmusic",
            })}
          >
        ...
        <li>
          <Link
            ...
            className={clsx(styles.menuItem, {
              [styles.active]: pathname === "/admin/admintype",
            })}
          >
        ...
        <li>
          <Link
            ...
            className={clsx(styles.menuItem, {
              [styles.active]: pathname === "/admin/adminalbum",
            })}
          >
        ...
        <li>
          <Link
            ...
            className={clsx(styles.menuItem, {
              [styles.active]: pathname === "/admin/adminartist",
            })}
          >
            <ReactSVG
              className={styles.csvg}
              src="/iconamoon_music-artist.svg"
            />
        ...
        <li>
          <Link
            ...
            className={clsx(styles.menuItem, {
              [styles.active]: pathname === "/admin/admincomposer",
            })}
          >
            <ReactSVG
              className={styles.csvg}
        ...
        <li>
          <Link
            ...
            className={clsx(styles.menuItem, {
              [styles.active]: pathname === "/admin/adminuser",
            })}
          >
